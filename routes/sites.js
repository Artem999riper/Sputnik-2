...
module.exports = (app, getDb, L) => {
  ...
  app.put('/api/sites/:id/bases', (req, res) => {
  ...
  // ── VOLUMES ────────────────────────────────────────────────
  app.post('/api/sites/:id/volumes', (req, res) => {
    const id = uuid();
  ...
  app.put('/api/vol_progress/:id', (req, res) => {
    const d = db();
  ...
  app.delete('/api/vol_progress/:id', (req, res) => {
    run(db(), 'DELETE FROM vol_progress WHERE id=?', [req.params.id]);
    res.json({ success: true });
  });

  // ── PROGRESS ITEMS ─────────────────────────────────────────
  app.post('/api/sites/:id/progress', (req, res) => {
    const id = uuid();
  ...
  // ── КАМЕРАЛЬНЫЕ РАБОТЫ ─────────────────────────────────────
  app.post('/api/sites/:id/kameral', (req, res) => {
    const id = uuid();
  ...
  app.put('/api/kameral/:id', (req, res) => {
  ...
  app.delete('/api/kameral/:id', (req, res) => {
    const d = db();
  ...
  app.post('/api/kameral/:id/remarks', (req, res) => {
    const rid = uuid();
  ...
  // ── SITE TASKS ─────────────────────────────────────────────
  app.post('/api/sites/:id/tasks', (req, res) => {
    const id = uuid();
